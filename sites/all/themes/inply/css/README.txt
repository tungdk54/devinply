...
To use these stylesheets, rename the files and inply_vn with the name of your theme.
...
inply_vn-alpha-default-narrow.css  
...
inply_vn-alpha-default-normal.css
...
inply_vn-alpha-default-wide.css
