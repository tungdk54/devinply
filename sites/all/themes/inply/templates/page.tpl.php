...
<div class="main-container container">
  ...
  <div class="row">
    ...
    <section class="<?php if(in_array(arg(0), $page_one_column)){echo 'col-sm-12 col-xs-12'; }else {echo 'col-sm-8 col-xs-12';} ?>">
    ...
    <?php if (!empty($page['sidebar_second']) &&!in_array(arg(0), $page_one_column)): ?>
      <aside class="col-sm-4 col-xs-12" role="complementary">
