jQuery(document).ready(function($){
  ...
  if($('#page .zone-content section.block-views-du-an-right-sidebar-block h2.block-title').length > 0) {
    $('#page .zone-content section.block-views-du-an-right-sidebar-block h2.block-title').wrapInner('<a href="/inply.vn/du-an"></a>');
  }
  if($('#page .zone-content section.block-views-tin-tuc-view-block-1 h2.block-title').length > 0) {
    $('#page .zone-content section.block-views-tin-tuc-view-block-1 h2.block-title').wrapInner('<a href="/inply.vn/tin-tuc-cong-ty"></a>');
  }
  if($('#page .zone-content section.block-views-tin-tuc-view-block-2 h2.block-title').length > 0) {
    $('#page .zone-content section.block-views-tin-tuc-view-block-2 h2.block-title').wrapInner('<a href="/inply.vn/doi-tac"></a>');
  }
  if($('#page .zone-content section.block-views-tin-tuc-view-block-3 h2.block-title').length > 0) {
    $('#page .zone-content section.block-views-tin-tuc-view-block-3 h2.block-title').wrapInner('<a href="/inply.vn/khach-hang"></a>');
  }
